...
def update():
    ...
    collect_time = b_check - a_start
    scale_time = c_check - b_check
    print 'collect time:' + str(collect_time)
    print 'scale time:' + str(scale_time)
...
def fit_spectrum():
    ...
    d_check = time.clock()
    pre_fit = b_check - a_start
    fit = c_check - b_check
    post_fit = d_check - c_check
    print 'prefit ' + str(pre_fit)
    print 'fit ' + str(fit)
    print 'postfit ' + str(post_fit)
