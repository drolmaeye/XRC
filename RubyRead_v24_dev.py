...
v24_dev pressure PV for idb only                                                  
'''
...
class Window(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.test_9000_btn = QtGui.QPushButton('Zoom Full')
        self.test_9999_btn = QtGui.QPushButton('Zoom Fit')
        self.asave_btn = QtGui.QPushButton('Save')
        self.asave_btn.setCheckable(True)
        ...
        self.tb_layout.addWidget(self.asave_btn)
        ...
        self.epics_custom_label = QtGui.QLabel('Custom PV Entry')
        self.epics_custom_entry = QtGui.QLineEdit()
        ...
        # ###Save tab###
        # make Save tab
        self.save_tab = QtGui.QWidget()
        self.save_tab_layout = QtGui.QVBoxLayout()
        self.save_tab_layout.setAlignment(QtCore.Qt.AlignTop)
        self.save_tab.setLayout(self.save_tab_layout)

        # make widgets
        self.save_fname_label = QtGui.QLabel('Enter file name')
        # ###self.epics_drop = QtGui.QComboBox()
        # ###self.epics_drop.addItems(['None (disconnected)',
        # ###                          'Lake Shore 336 TC1 Input 1',
        # ###                          'Lake Shore 336 TC1 Input 2',
        ...
        # ###self.epics_status_display = QtGui.QLabel('Disconnected')
        # ###self.epics_custom_label = QtGui.QLabel('Custom PV Entry')
        self.save_fname_entry = QtGui.QLineEdit()
        ...
        # add widgets to layout
        self.save_tab_layout.addWidget(self.save_fname_label)
        self.save_tab_layout.addWidget(self.save_fname_entry)
        ...
        self.ow.addTab(self.save_tab, 'Save')
...
class CoreData:
    def __init__(self):
        ...
        self.index = 1
        self.press_pv = PV('16idb:Reg1.VAL')
...
def calculate_pressure(lambda_r1):
    ...
    if gui.asave_btn.isChecked():
        core.press_pv.put(core.pressure)
